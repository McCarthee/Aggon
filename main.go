...
func printDeclarativeHelp() {
	...
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  aggon <command> [options]")
	fmt.Println()
	...
	fmt.Println("  aggon init")
	fmt.Println("  aggon plan")
	fmt.Println("  aggon switch")
	fmt.Println("  aggon rollback 5")
}
